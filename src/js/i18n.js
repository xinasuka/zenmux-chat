...
export const TRANSLATIONS = {
  zh: {
    ...
    share: {
      ...
      alreadySharedBadge: '已有分享链接',
      retrievedNotice: '检测到此会话此前已发布过在线快照。若需应用最新排版与内容，请点击「更新内容」。',
      updateSnapshot: '更新内容',
      updateBtn: '更新此分享链接内容',
      updating: '正在更新并同步快照…',
  ...
  en: {
    ...
    share: {
      ...
      alreadySharedBadge: 'Existing Share Link',
      retrievedNotice: 'This session was previously published. Click "Update Content" to sync the latest changes.',
      updateSnapshot: 'Update Content',
