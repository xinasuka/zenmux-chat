...
export const TRANSLATIONS = {
  zh: {
    ...
    share: {
      ...
      drawerHint: '点击上方对话任意区域或勾选框即可自由增减分享内容。',
      autoMetricsNotice: '✦ 思考过程与模型指标已自动内嵌',
      retentionLabel: '保留策略',
      ttl7d: '7 天有效 (推荐)',
      ttl14d: '14 天有效',
      ttl30d: '30 天有效',
      ttlPermanent: '永久保留 (FIFO 自动轮转)',
      ...
      permanentNotice: '该快照永久有效，但在账号快照达到 500 个上限时将遵循先进先出 (FIFO) 自动轮转。',
      shareFailed: '分享发布失败: {error}',
      emptySelection: '请至少选择一轮对话进行分享',
      copied: '分享链接已复制到剪贴板',
      retrievedSuccess: '已获取该轮已有分享链接并自动复制到剪贴板',
      updateSnapshot: '修改内容或重新选轮',
      updateBtn: '更新此分享链接内容',
      updating: '正在更新并同步快照…',
  ...
  en: {
    ...
    share: {
      ...
      drawerHint: 'Click any message turn above or checkbox to toggle inclusion.',
      autoMetricsNotice: '✦ Reasoning & metrics automatically included',
      retentionLabel: 'Retention Policy',
      ttl7d: '7 Days (Recommended)',
      ttl14d: '14 Days',
      ttl30d: '30 Days',
      ttlPermanent: 'Permanent (FIFO Rotated)',
      ...
      permanentNotice: 'This snapshot is permanent, subject to FIFO rotation when reaching the 500 site limit.',
      shareFailed: 'Failed to share session: {error}',
      emptySelection: 'Please select at least one interaction to share',
      copied: 'Share link copied to clipboard',
      retrievedSuccess: 'Existing share link retrieved and copied to clipboard',
      updateSnapshot: 'Modify Selection & Update',
