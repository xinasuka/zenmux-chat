...
export const APP_VERSION = '2.21.34';
...
export const el = {
  ...
  settingsVadEngine: $('settings-vad-engine'),
  settingsVadBadge: $('settings-vad-badge'),
  settingsVadStatusText: $('settings-vad-status-text'),
