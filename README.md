...
* **One-Click Conversation Sharing**: Generate clean, shareable web links for any conversation turn with customizable expiration dates (1, 7, 30, 90 days, or permanent), preserving full markdown formatting, thinking processes, and images. Seamlessly integrates with native mobile share sheets to send rich preview cards directly to WeChat, Telegram, and X (Twitter). Recipients can view on any device or import the conversation into their own ZenChat with one click.
...
10. **一键对话快照与原生分享**：支持将任意轮次的精彩问答一键发布为在线网页，支持自选有效期（1天、7天、30天、90天或永久有效），完整保留排版、思考过程与配图。一键唤起手机系统分享，发送至微信、Telegram、X (Twitter) 等社交平台时自动呈现精美预览大卡片；好友无需注册即可直接浏览，或一键导入到自己的 ZenChat 中继续追问。
